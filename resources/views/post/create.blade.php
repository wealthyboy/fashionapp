                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/post/store') }}" id="upload-post">
                        ...
                        <div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ old('subject') }}">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                            <button type="button" class="btn btn-primary" id="uploads-post">
                                 Create New Post
                            </button>
...
$("form#addPhotosForm").dropzone({
  ...
  $(function() {
    $('#uploads-post').on('click', function() {
      alert('yup');
